...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Die Projekt ID ist eine eindeutige Identifikationsnummer eines angelegten Händlerprojekts. Der Händler kann eine beliebige Anzahl von Projekten im [Novalnet-Händleradministrationsportal](https://admin.novalnet.de/) erstellen.</td>
        </tr>
        <tr>
            <td><b>Tarif-ID</b></td>
            <td>Die Tarif ID ist eine eindeutige Identifikationsnummer für jedes angelegte Projekt. Der Händler kann eine beliebige Anzahl von Tarifen im [Novalnet-Händleradministrationsportal](https://admin.novalnet.de/) erstellen.</td>
        </tr>
        <tr>
